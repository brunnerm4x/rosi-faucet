...
var url_walletserv = "http://localhost:10021";

if(typeof process.env.npm_package_config_usewalletserver == "string")
{
	url_walletserv = process.env.npm_package_config_usewalletserver;	
	console.log("Using Environment Variable for url_walletserv, value: " + url_walletserv);
}
